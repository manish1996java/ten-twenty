...
import { ArrowDown, ArrowDownUp, ArrowUp, ChevronDown, ChevronsUpDown, ChevronUp } from "lucide-react";


interface TimesheetTableProps<T> {
    data: T[];
}


export default function TimesheetTable<T>() {
